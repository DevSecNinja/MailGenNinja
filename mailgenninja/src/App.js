    ...
    <div className="App">
      <header className="App-header">
        ...
        <p>MailGenNinja is a sleek and user-friendly web app designed to effortlessly generate unique email addresses for each website registration, enhancing your online security and organization.
          Embodying the precision and agility of a ninja, this app simplifies email management and seamlessly integrates with Office 365 mail-enabled security groups for a streamlined experience.</p>
